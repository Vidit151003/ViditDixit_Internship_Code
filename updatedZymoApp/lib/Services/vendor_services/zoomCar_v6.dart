...
class ZoomCarServicesV6 {
  ...
  static List<PickupModel> newGetpickup(
    ...
    final PickupModel pickUpModel = PickupModel(pickupAddress: location)
      ..deliveryCharges = 0
  ...
  static Future<String?> getUserToken(String token, {bool isRetry= true}) async {
    try {
  ...
  static Future<String?> getTokenHttps({bool isRetry= true}) async {
    try {
